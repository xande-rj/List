...
const userCreateSchema = z.object({
  ...
  sexo : z.string({invalid_type_error: "verifique se o sexo digita esta correto"}).min(3).optional(),
  idade : z.number({ invalid_type_error: "Por favor digite a idade corretamente"}).int().optional(),
  cidade : z.string({invalid_type_error: "verifique se a cidade esta correta"}).min(10,"Verifique se a cidade digitada esta com o nome completo").optional()
}) 
